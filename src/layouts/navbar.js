    ...
    <div className="py-8">
      <div className="flex justify-between items-center gap-4 bg-[var(--gray-100)] border border-[var(--gray-300)] rounded-[100px] py-[10px] px-6">
        ...
        <div className="flex justify-between items-center gap-2 w-max">
          <button className="outline-0 py-[14px] px-6 text-sm font-medium bg-white rounded-[100px] border border-[var(--gray-400)] shadow-[0 1px 2px #1018280d] cursor-pointer">
            Talk to Sales
          </button>
          <button className="outline-0 py-[14px] px-6 text-sm font-medium text-white bg-[var(--blue-700)] rounded-[100px] shadow-[0 1px 2px #1018280d] cursor-pointer">
            Sign up for Free
          </button>
        </div>
      </div>
